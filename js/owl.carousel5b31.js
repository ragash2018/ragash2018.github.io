...
(function( $, window, document, undefined ) {
	...
	var Carousel = {
		init :function(options, el){
			var base = this;
			base.options = jQuery.extend({}, jQuery.fn.owlCarousel.options, options);
		...
		updateItems : function(){
			...
			var width = jQuery(base.options.responsiveBaseWidth).width();
		...
		buildButtons : function(){
			var base = this;
			var buttonsWrapper = jQuery("<div class=\"owl-buttons\"/>")
		...
		updatePagination : function(){
			...
			for(var i = 0; i<base.itemsAmount; i++){
				if(i % base.options.items === 0){
					...
					var paginationButton = jQuery("<div/>",{
						"class" : "owl-page"
						});
					var paginationButtonInner = jQuery("<span></span>",{
			...
			function dragEnd(event){
				...
				if(base.newRelativeX !== 0){
					...
					if(locals.targetElement === event.target && base.browser.isTouch !== true){
						jQuery(event.target).on("click.disable", function(ev){
							ev.stopImmediatePropagation();
							ev.stopPropagation();
							ev.preventDefault();
							jQuery(event.target).off("click.disable");
						});
						var handlers = jQuery._data(event.target, "events")["click"];
		...
		lazyLoad : function(){
			...
			for(var i=0; i<base.itemsAmount; i++){
				var $item = jQuery(base.$owlItems[i]);
		...
		autoHeight : function(){
			var base = this;
			var $currentimg = jQuery(base.$owlItems[base.currentItem]).find("img");
		...
		reinit : function(newOptions){
			var base = this;
			var options = jQuery.extend({}, base.userOptions, newOptions);
		 	base.unWrap();
